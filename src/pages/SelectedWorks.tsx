...
const projects = [
  {
    ...
    description: "Built a high performance backend that manages the full order lifecycle with complete CRUD support, reducing query execution time by 40%.",
    links: { live: "https://github.com/koustubh-v", code: "#" },
    image: "/Assets/Images/p1.png",
    cta: "View on Github"
  },
  {
    id: "002",
    title: "Seva-AI: Volunteer Platform",
    stack: "TypeScript / Node.js",
    description: "Engineered a resilient backend that handles concurrent data streams with low latency, using clean architecture for cross-functional deployment decisions.",
    links: { live: "https://github.com/koustubh-v", code: "#" },
  ...
  },
  {
    id: "003",
    title: "LegalMind AI",
    stack: "Flask / Microservices",
    description: "Designed a production backend with 14 loosely coupled microservices for automated legal risk assessment, reducing manual review time by 60%.",
    links: { live: "https://github.com/koustubh-v", code: "#" },
  ...
  {
    id: "004",
    title: "ContextIQ: Shopping Assistant",
    stack: "Agentic RAG / Node.js / ChromaDB",
    description: "Built a context-aware product recommendation engine using Agentic RAG and multimodal understanding to improve personalization.",
    links: { live: "https://github.com/koustubh-v", code: "#" },
