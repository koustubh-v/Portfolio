      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a
              href="https://x.com/verma_koustubh"
              target="_blank"
              rel="noopener noreferrer"
              className="font-sans text-xs md:text-sm font-medium uppercase tracking-wide hover:underline underline-offset-4 decoration-1 w-fit flex items-center gap-1"
            >
      ...
      >
        <div className="w-full overflow-hidden whitespace-nowrap flex">
          <motion.div
            ...
            className="font-sans font-black text-[12vw] leading-[1] text-white uppercase tracking-tighter flex items-center min-w-max"
          >
            <span className="pr-10">Web Developer | ML Engineer | Competitive Programmer |</span>
            <span className="pr-10">Web Developer | ML Engineer | Competitive Programmer |</span>
          </motion.div>
        </div>
      </motion.div>
